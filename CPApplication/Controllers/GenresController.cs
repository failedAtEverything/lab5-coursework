...
namespace CPApplication.Controllers
{
    ...
    public class GenresController : Controller
    {
        ...
        {
              return View(await _context.Genres.AsNoTracking().ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Genre genre)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    bool tracking = _context.ChangeTracker.Entries<Genre>().Any(x => x.Entity.Id == genre.Id);
                    if (!tracking)
                    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TvChannelContext.Genres'  is null.");
            }
